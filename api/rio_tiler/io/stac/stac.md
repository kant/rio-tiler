...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/vnd.stac.geotiff; cloud-optimized=true', 'image/tiff; application=geotiff', 'image/jp2', 'image/x.geotiff', 'application/x-hdf5', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'application/x-hdf', 'image/tiff'},
